...
async function createPayment(payment: any) {
    ...
    const requestOptions: RequestInit = {
        ...
        let url = new URL(`http://localhost:3000/payments/create-payment`);
...
async function getPayment(id?: string) {
    ...
    const requestOptions: RequestInit = {
        ...
        let url = new URL(`http://localhost:3000/payments/get-payment/${id}`);
        return fetch(url, requestOptions)
        .then(res => {
            if (res.ok) {
                return res.json();
...
async function updatePayment(payment: any) {
    ...
    const requestOptions: RequestInit = {
        ...
        let url = new URL(`http://localhost:3000/payments/update-payment/${payment.id}`);
        return fetch(url, requestOptions)
        .then(res => {
            if (res.ok) {
                return res.json();
...
async function deletePayment(id: any) {
    ...
    const requestOptions: RequestInit = {
        ...
        let url = new URL(`http://localhost:3000/payments/delete-payment/${id}`);
        return fetch(url, requestOptions)
        .then(res => {
            if (res.ok) {
                return res.json();
...
async function listPayments(client?: string) {
    ...
    const requestOptions: RequestInit = {
        ...
        let url = new URL('http://localhost:3000/payments/list-payments');
